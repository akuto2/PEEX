...
public class GuiCollectorMK8 extends GuiContainer{
	...
	private TileEntityCollectorMk8 tile;

	public GuiCollectorMK8(InventoryPlayer invPlayer, TileEntityCollectorMk8 tile)
	{
		super(new ContainerCollectorMk8(invPlayer, tile));
		this.tile = tile;
		this.xSize = 218;
		this.ySize = 165;
	}
