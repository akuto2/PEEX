...
public class ContainerCollectorMk10 extends Container{
	private TileEntityCollectorMk10 tile;
	private int sunLevel;

	public ContainerCollectorMk10(InventoryPlayer inPlayer, TileEntityCollectorMk10 collector){
		this.tile = collector;
