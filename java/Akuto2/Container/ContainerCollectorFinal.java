...
public class ContainerCollectorFinal extends Container {
	private TileEntityCollectorFinal tile;
	private int sunLevel;

	public ContainerCollectorFinal(InventoryPlayer inPlayer, TileEntityCollectorFinal collector){
		this.tile = collector;
