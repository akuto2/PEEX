...
public class GuiCollectorMk7 extends GuiContainer{
	...
	private final TileEntityCollectorMk7 tile;
	private final ContainerCollectorMk7 container;

	public GuiCollectorMk7(InventoryPlayer invPlayer, TileEntityCollectorMk7 collector) {
		super(new ContainerCollectorMk7(invPlayer, collector));
		tile = collector;
		container = ((ContainerCollectorMk7)inventorySlots);
		xSize = 218;
		ySize = 165;
	}
