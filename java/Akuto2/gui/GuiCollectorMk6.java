...
public class GuiCollectorMk6 extends GuiContainer{
	...
	private final TileEntityCollectorMk6 tile;
	private final ContainerCollectorMk6 container;

	public GuiCollectorMk6(InventoryPlayer invPlayer, TileEntityCollectorMk6 collector) {
		super(new ContainerCollectorMk6(invPlayer, collector));
		tile = collector;
		container = ((ContainerCollectorMk6)inventorySlots);
		xSize = 218;
		ySize = 165;
	}
