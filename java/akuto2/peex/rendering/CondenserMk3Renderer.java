...
public class CondenserMk3Renderer extends TileEntitySpecialRenderer{
	private final ResourceLocation texture = new ResourceLocation("PEEX".toLowerCase(), "textures/blocks/condenser_mk3.png");
