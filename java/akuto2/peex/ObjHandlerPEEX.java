...
import akuto2.peex.blocks.BlockBlueMatter;
import akuto2.peex.blocks.BlockChaosMatter;
...
import akuto2.peex.items.ItemArchangeRingMk2;
import akuto2.peex.items.armor.BMArmor;
import akuto2.peex.items.armor.CMArmor;
...
public class ObjHandlerPEEX {
	...
	private static Register register = new Register(PEEXCore.tabPEEX);

	public static void register() {
		relayMk4 = new BlockRelay(4);
		register.register(relayMk4, "relayMk4");
		relayMk5 = new BlockRelay(5);
		register.register(relayMk5, "relayMk5");
		bluematter = new Item().setCreativeTab(PEEXCore.tabPEEX).setTextureName("peex:bluematter").setUnlocalizedName("bluematter");
		register.register(bluematter, "bluematter");
		chaosmatter = new Item().setCreativeTab(PEEXCore.tabPEEX).setTextureName("peex:chaosmatter").setUnlocalizedName("chaosmatter");
		register.register(chaosmatter, "chaosmatter");
		bluematterBlock = new BlockBlueMatter();
		register.register(bluematterBlock, "bluematterBlock");
		chaosmatterBlock = new BlockChaosMatter();
		register.register(chaosmatterBlock, "chaosmatterBlock");
		archangelRingMk2 = new ItemArchangeRingMk2();
		register.register(archangelRingMk2, "archangelRingMk2");
...
//		GameRegistry.registerBlock(transmutationStoneMk2, "transmutationStonePEEX");
	...
	public static void addRecipe() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(bluematter, 9), new ItemStack(bluematterBlock));
		GameRegistry.addShapelessRecipe(new ItemStack(chaosmatter, 9), new ItemStack(chaosmatterBlock));
	...
	public static void registerPEAA() {
		...
		register.register(condenserMk3, "condenserMk3");
		aeguEXMk1_off = new BlockAEGUEX(1, false);
		register.register(aeguEXMk1_off, "aeguEXMk1_off");
		aeguEXMk1_on = new BlockAEGUEX(1, true);
		register.register(aeguEXMk1_on, "aeguEXMk1_on", false);
		aeguEXMk2_off = new BlockAEGUEX(2, false);
		register.register(aeguEXMk2_off, "aeguEXMk2_off");
		aeguEXMk2_on = new BlockAEGUEX(2, true);
		register.register(aeguEXMk2_on, "aeguEXMk2_on", false);
		aeguEXMK3_off = new BlockAEGUEX(3, false);
		register.register(aeguEXMK3_off, "aeguEXMK3_off");
		aeguEXMK3_on = new BlockAEGUEX(3, true);
		register.register(aeguEXMK3_on, "aeguEXMK3_on", false);
		collectorMk6 = new BlockCollector(6);
		register.register(collectorMk6, "collectorMk6");
		collectorMk7 = new BlockCollector(7);
		register.register(collectorMk7, "collectorMk7");
		collectorMk8 = new BlockCollector(8);
		register.register(collectorMk8, "collectorMk8");
		collectorMk9 = new BlockCollector(9);
		register.register(collectorMk9, "collectorMk9");
		collectorMk10 = new BlockCollector(10);
		register.register(collectorMk10, "collectorMk10");
		collectorFinal = new BlockCollector(99);
		register.register(collectorFinal, "collectorFinal");
		relayFinal = new BlockRelay(99);
		register.register(relayFinal, "relayFinal");
		aeguEXFinal_off = new BlockAEGUEX(4, false);
		register.register(aeguEXFinal_off, "aeguEXFinal_off");
		aeguEXFinal_on = new BlockAEGUEX(4, true);
		register.register(aeguEXFinal_on, "aeguEXFinal_on", false);
		condenserGrade0 = new BlockCondenserGrade0();
		register.register(condenserGrade0, "condenserGrade0");
