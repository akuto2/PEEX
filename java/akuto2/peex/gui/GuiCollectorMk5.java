...
public class GuiCollectorMk5 extends GuiContainer{
	private static final ResourceLocation texture = new ResourceLocation("peex", "textures/gui/collector3.png");
	private final TileEntityCollectorMk5 tile;
	private final ContainerCollectorMk5 container;

	public GuiCollectorMk5(InventoryPlayer invPlayer, TileEntityCollectorMk5 collector) {
		super(new ContainerCollectorMk5(invPlayer, collector));
		tile = collector;
		container = ((ContainerCollectorMk5)inventorySlots);
		xSize = 218;
		ySize = 165;
	}
