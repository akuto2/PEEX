...
public class GuiRelayFinal extends GuiContainer{
	private static final ResourceLocation texture = new ResourceLocation("peex", "textures/gui/relay3.png");
	private final TileEntityRelayFinal tile;
	private final ContainerRelayFinal container;

	public GuiRelayFinal(InventoryPlayer invPlayer, TileEntityRelayFinal tile) {
		super(new ContainerRelayFinal(invPlayer, tile));
		this.tile = tile;
		this.container = (ContainerRelayFinal)inventorySlots;
		xSize = 212;
		ySize = 194;
	}
