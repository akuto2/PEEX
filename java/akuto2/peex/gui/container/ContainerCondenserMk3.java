...
import akuto2.peex.gui.container.slots.condenser.SlotCondenserMK3Lock;
import akuto2.peex.gui.container.slots.condenser.SlotCondenserMK3Output;
...
public class ContainerCondenserMk3 extends Container{
	...
	public ContainerCondenserMk3(InventoryPlayer invPlayer, TileEntityCondenserMk3 condenser)
	{
		...
		//Item Lock Slot
		this.addSlotToContainer(new SlotCondenserMK3Lock(this, 0, 12, 6));
		...
		for (int i = 0; i < 7; i++)
			for (int j = 0; j < 6; j++)
				this.addSlotToContainer(new SlotCondenserMK3Output(tile, 43 + j + i * 6, 138 + j * 18, 26 + i * 18));
