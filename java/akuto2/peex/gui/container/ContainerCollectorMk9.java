...
public class ContainerCollectorMk9 extends Container{
	private TileEntityCollectorMk9 tile;
	private int sunLevel;

	public ContainerCollectorMk9(InventoryPlayer inPlayer, TileEntityCollectorMk9 collector){
		this.tile = collector;
