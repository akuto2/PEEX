...
public class GuiCollectorMk8 extends GuiContainer{
	private static final ResourceLocation texture = new ResourceLocation("peex", "textures/gui/collector3.png");
	private final TileEntityCollectorMk8 tile;
	private final ContainerCollectorMk8 container;

	public GuiCollectorMk8(InventoryPlayer invPlayer, TileEntityCollectorMk8 collector) {
		super(new ContainerCollectorMk8(invPlayer, collector));
		tile = collector;
		container = ((ContainerCollectorMk8)inventorySlots);
		xSize = 218;
		ySize = 165;
	}
